...
function RestaurantDashboard() {
  ...
  const loadDashboard = async () => {
    ...
    try {
      ...
      const activeRestaurant =
        ownerRestaurants.find((restaurant) => restaurant._id === nextSelectedId) || firstRestaurant;
  ...
  const handleRestaurantSubmit = async (event) => {
    ...
    try {
      const updatedRestaurant = await updateRestuarant(currentRestaurant._id, restaurantForm, token);
      setRestaurants(
  ...
  const handleDeleteRestaurant = async () => {
    ...
    try {
      await deleteRestuarant(currentRestaurant._id, token);
      ...
      const newFood = await createFood(
        {
          ...
          restuarantId: currentRestaurant._id,
        },
        token
      );
